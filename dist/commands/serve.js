...
var local_api_1 = require("@code.it/local-api");
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    console.log("Server running on http://localhost:" + options.port + " and loading cells from file " + filename);
                    return [3 /*break*/, 3];
                case 2:
                    err_1 = _a.sent();
                    if (err_1.code === 'EADDRINUSE') {
                        console.error("Port " + err_1.port + " is in use. Try running on a different port");
                    }
                    else {
